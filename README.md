...
The chatbot is grounded in official Elata® product documentation sourced from the Enable Lifecare resource library:

https://enablelifecare.com.au/pages/elata-resources

This includes:

* Individual product user manuals (E300, E400, E500, E600, E700)
* Product brochures (foam, hybrid, and alternating air systems)
* Supporting technical documentation (e.g. pressure mapping reports)

These documents were processed into a structured internal knowledge base (`data/kb.json`) using page-level chunking for retrieval.

Product specifications used in the recommendation engine (e.g. pressure injury stage support, safe working load, powered vs non-powered) were manually verified against Section 1 of each product’s user manual and encoded in a typed `PRODUCT_SPECS` table.

The original PDF files are not included in this repository. All responses generated by the chatbot are strictly derived from the extracted content of these official documents.
